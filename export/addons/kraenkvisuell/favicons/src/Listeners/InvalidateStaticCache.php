...
namespace Kraenkvisuell\Favicons\Listeners;

use Illuminate\Contracts\Queue\ShouldQueue;
use Statamic\Facades\URL;
use Kraenkvisuell\Favicons\Events\SiteDefaultsSaved;
...
class InvalidateStaticCache implements ShouldQueue
{
    ...
    public function handle(SiteDefaultsSaved $event): void
    {
        ...
        $rules = collect(Arr::get($this->rules, 'favicons_site_defaults.urls'));
