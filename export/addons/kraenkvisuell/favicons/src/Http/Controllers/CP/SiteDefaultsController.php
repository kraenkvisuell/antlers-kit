...
class SiteDefaultsController extends CpController
{
    ...
    {
        $this->authorize('edit favicons site defaults');
        ...
        $viewData = [
            ...
            'initialSite' => $site,
            'action' => cp_route('favicons.site-defaults.update'),
            'configureUrl' => cp_route('favicons.site-defaults.configure.edit'),
        ];
        ...
        return Inertia::render('favicons::SiteDefaults/Edit', $viewData);
    }
