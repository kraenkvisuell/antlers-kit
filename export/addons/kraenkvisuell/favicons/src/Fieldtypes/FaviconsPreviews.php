...
class FaviconsPreviews extends Fieldtype
{
    ...
    public function preload()
    {
        return [
            ...
            'previewUrl' => cp_route('favicons.preview'),
            'assetContainerUrl' => config('statamic.favicons.assets.container')
                ? AssetContainer::find(config('statamic.favicons.assets.container'))->url()
                : null,
    ...
    private function faviconUrl(): ?string
    {
        ...
        return Cache::rememberForever("favicons::favicon.{$domain}", function () use ($domain) {
